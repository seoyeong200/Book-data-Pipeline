...
author = '''
alter table items change author author VARCHAR(150);
'''
image = '''
alter table items change image image VARCHAR(200);
'''
ranking = '''
alter table items change ranking ranking INT;
'''
descr = '''
alter table items change description description VARCHAR(3000);
'''
